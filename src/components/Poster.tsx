...
const Poster: React.FC<{ track: InTrack }> = ({ track }) => {
  ...
  return (
    <div className="w-[160px] h-[160px] rounded-lg shadow-md overflow-hidden relative text-white/80 cursor-pointer hover:scale-105 hover:text-white/100 transition duration-200 ease-out group mx-auto">
      <picture>
        <img
          src={track.albumUrl}
          onClick={handlerSong}
      ...
      <div className="absolute bottom-4 inset-x-0 ml-2 flex items-center space-x-3.5">
        <div
          onClick={handlePlay}
          className="h-9 w-9 bg-[#15883e] rounded-full flex items-center justify-center group-hover:bg-[#1db954] flex-shrink-0"
        >
