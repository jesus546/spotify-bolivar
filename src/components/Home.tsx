...
export const Home: React.FC<{ spotifyApi: SpotifyWebApi }> = ({ spotifyApi }) => {
                ...
                {loadingPlayed ?
                    <div className='flex justify-between'>
                        {[...Array(4)].map((value: number, i: number) => (
                            <div key={i} className="flex items-center justify-center w-64 h-52 bg-gray-300 rounded sm:w-96 dark:bg-gray-700">
            ...
            <div className='py-3 px-4'>
                {loadingPlayed ?
                    ...
                    <Slider className='!py-6' {...settings}>
                        {newReleases.map((value: any, i: number) => (
                            <Poster
                                key={i}
                                track={value}
                            />
