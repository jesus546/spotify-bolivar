...
const Categories: React.FC<{ track: any }> = ({ track }) => {
  ...
  return (
    <div
      onClick={soon}
      className="w-full h-full rounded-lg shadow-md bg-black overflow-hidden relative text-white/80 cursor-pointer hover:scale-105 hover:text-white/100 transition duration-200 ease-out group mx-auto"
    >
      <picture>
        <img
